...
public class App{
    ...
    public static void main(String[] args) {
        ...
        pricingService.addStrategy("P002", new BulkDiscountStrategy(6, 0.1));
        ...
        pricingService.addStrategy("P001", new BulkDiscountStrategy(3, 0.5)); // เปลี่ยนโปรโมชัน Apple เป็นซื้อ 3 ลด 50%
